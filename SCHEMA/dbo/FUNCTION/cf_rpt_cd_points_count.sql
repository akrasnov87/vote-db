CREATE OR REPLACE FUNCTION dbo.cf_rpt_cd_points_count(_fn_user integer, _default integer, _f_type integer) RETURNS bigint
...
ALTER FUNCTION dbo.cf_rpt_cd_points_count(_fn_user integer, _default integer, _f_type integer) OWNER TO mobnius;
