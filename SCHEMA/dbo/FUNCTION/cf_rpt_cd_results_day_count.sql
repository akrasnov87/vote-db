CREATE OR REPLACE FUNCTION dbo.cf_rpt_cd_results_day_count(_fn_user integer, _f_type integer) RETURNS bigint
...
ALTER FUNCTION dbo.cf_rpt_cd_results_day_count(_fn_user integer, _f_type integer) OWNER TO mobnius;
