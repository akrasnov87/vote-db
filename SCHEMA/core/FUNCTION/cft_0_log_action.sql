CREATE OR REPLACE FUNCTION core.cft_0_log_action() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION core.cft_0_log_action() OWNER TO mobnius;

COMMENT ON FUNCTION core.cft_0_log_action() IS 'Процедура логирования действия пользователя';
